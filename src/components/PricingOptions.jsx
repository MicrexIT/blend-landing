...
export function PricingOptions({ callToAction }) {
  ...
  return (
    <div
      ...
      className="relative z-10 flex flex-col items-center justify-center p-2 md:px-9 lg:px-28 xl:px-32 gap-20"
...
function PricingTitleIconCell({ content, subContent, icon }) {
  return (
    <div className="flex flex-shrink-0 flex-row items-start gap-0.5 md:gap-2 lg:gap-3">
